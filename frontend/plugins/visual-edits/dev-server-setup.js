...
function setupDevServer(config) {
  config.setupMiddlewares = (middlewares, devServer) => {
    ...
    const isAllowedOrigin = (origin) => {
      ...
      // Allow HTTPS connections (add your domain patterns here)
      // Example: if (origin.match(/^https:\/\/([a-zA-Z0-9-]+\.)*yourdomain\.com$/)) { return true; }

      // Allow from any HTTPS domain (for production, restrict this)
